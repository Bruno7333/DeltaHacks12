...
async function main() {
  try {
    ...
    // Convert text to a Readable stream and write to file
    const audioStream = await client.textToSpeech.convert(voiceId, {
      text: "Hello Bruno, your ElevenLabs API is working!",
    ...
    await writeAudioToFile(audioStream, "output.mp3");
